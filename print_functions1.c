...
/**
 * print_octal - Prints unsigned number that is in octal notation
 * @types: List of all arguments
 * @buffer: Buffer array that handle print
 * @flags:  Calculator of active flags
 * @width: get width
...
/**
 * print_hexadecimal - Prints unsigned number found in hexadecimal notation
 * @types: List of all arguments
...
/**
 * print_hexa_upper - Prints unsigned number occuring in upper hexadecimal notation
 ...
 * @map_to: Array of values mapping the number to
 * @buffer: Buffer array handling print
 * @flags:  Calculator of active flags
 * @flag_ch: Calculator of active flags
 * @width: get width
 * @precision: Precision specification
 * @size: Size specification
 * @size: Size specification
